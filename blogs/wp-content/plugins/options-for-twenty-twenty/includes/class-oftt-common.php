...
if (!class_exists('ofttCommon')) {
	...
	class ofttCommon {
        ...
        public static $plugin_name = 'Options for Twenty Twenty';
        public static $plugin_prefix = 'oftt';
        public static $plugin_text_domain = 'options-for-twenty-twenty';
        public static $plugin_premium_class = 'options_for_twenty_twenty_premium_class';
        public static $plugin_trial = true;
        public static $plugin_upgrade = true;

		public static function plugin_version() {

            return options_for_twenty_twenty_class::$version;
