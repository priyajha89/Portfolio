...
function pg_activation_popup()
{
    event.preventDefault();
    jQuery('#pg-activation-popup').toggle();
    ...
    jQuery(document).ready(function () {
        jQuery('.pg-modal-box-close, .pg-modal-box-overlay').click(function () {
            setTimeout(function () {
                ...
                jQuery('.pg-offer-button button').click(function () {
...
$(".pg-previous-slide").click(function(){
	animating = true;
...
function validate_wizard(current_fs)
{
    ...
    jQuery('.'+cclass+' .pm_required').each(function (index, element) {
		var value = jQuery(this).children('input').val();
		var value = jQuery.trim(value);
		if (value == "") {
			jQuery(this).children('input').addClass('warning');
        ...
        jQuery('.'+cclass+' .pm_select_required').each(function (index, element) {
		var value = jQuery(this).children('select').val();
		var value = jQuery.trim(value);
		if (value == "") {
			jQuery(this).children('select').addClass('warning');
...
jQuery(document).ready(function($){
    var custom_uploader;
    $('.wizard_group_icon_button').click(function(e) {
