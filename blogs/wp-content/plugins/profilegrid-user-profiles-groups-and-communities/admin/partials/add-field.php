            ...
            <div class="uimrow" style="display:none;">
                ...
                <div class="uiminput">
                    <select name="field_type" id="field_type" onChange="pm_show_hide_field_option(this.value, 'field_options_wrapper')">
                        ...
                        <option value="heading" <?php if (isset($str) && $str == 'heading') echo 'selected'; ?>><?php esc_html_e('Heading','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="paragraph" <?php if (isset($str) && $str == 'paragraph') echo 'selected'; ?>><?php esc_html_e('Paragraph','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="read_only" <?php if (isset($str) && $str == 'read_only') echo 'selected'; ?>><?php esc_html_e('Read Only','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="text" <?php if (isset($str) && $str == 'text') echo 'selected'; ?>><?php esc_html_e('Text','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="url" <?php if (isset($str) && $str == 'url') echo 'selected'; ?>><?php esc_html_e('URL','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="select" <?php if (isset($str) && $str == 'select') echo 'selected'; ?>><?php esc_html_e('Drop Down','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="radio" <?php if (isset($str) && $str == 'radio') echo 'selected'; ?>><?php esc_html_e('Radio Button','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="textarea" <?php if (isset($str) && $str == 'textarea') echo 'selected'; ?>><?php esc_html_e('Text Area','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="checkbox" <?php if (isset($str) && $str == 'checkbox') echo 'selected'; ?>><?php esc_html_e('Check Box','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="DatePicker" <?php if (isset($str) && $str == 'DatePicker') echo 'selected'; ?>><?php esc_html_e('Date','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="email" <?php if (isset($str) && $str == 'email') echo 'selected'; ?>><?php esc_html_e('Email','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="number" <?php if (isset($str) && $str == 'number') echo 'selected'; ?>><?php esc_html_e('Number','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="country" <?php if (isset($str) && $str == 'country') echo 'selected'; ?>><?php esc_html_e('Country','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="timezone" <?php if (isset($str) && $str == 'timezone') echo 'selected'; ?>><?php esc_html_e('Timezone','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="term_checkbox" <?php if (isset($str) && $str == 'term_checkbox') echo 'selected'; ?>><?php esc_html_e('T&C Checkbox','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="file" <?php if (isset($str) && $str == 'file') echo 'selected'; ?>><?php esc_html_e('File Upload','profilegrid-user-profiles-groups-and-communities'); ?></option>
           <!-- <option value="pricing" <?php if (isset($str) && $str == 'pricing') echo 'selected'; ?>><?php esc_html_e('Pricing','profilegrid-user-profiles-groups-and-communities'); ?></option> -->
                        <option value="repeatable_text" <?php if (isset($str) && $str == 'repeatable_text') echo 'selected'; ?>><?php esc_html_e('Repeatable Text','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="first_name" <?php if (isset($str) && $str == 'first_name') echo 'selected'; ?>><?php esc_html_e('First Name','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="last_name" <?php if (isset($str) && $str == 'last_name') echo 'selected'; ?>><?php esc_html_e('Last Name','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="user_name" <?php if (isset($str) && $str == 'user_name') echo 'selected'; ?>><?php esc_html_e('Username','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <?php
                        $check = $pmrequests->pm_check_field_exist($gid, 'user_email', true);
                        if ($check === false || $str == 'user_email'):
                            ?>
                            <option value="user_email" <?php if (isset($str) && $str == 'user_email') echo 'selected'; ?>><?php esc_html_e('User Email','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <?php endif; ?> 
                        <option value="nickname" <?php if (isset($str) && $str == 'nickname') echo 'selected'; ?>><?php esc_html_e('Nickname','profilegrid-user-profiles-groups-and-communities'); ?></option>    
                        <option value="user_url" <?php if (isset($str) && $str == 'user_url') echo 'selected'; ?>><?php esc_html_e('Website','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="user_pass" <?php if (isset($str) && $str == 'user_pass') echo 'selected'; ?>><?php esc_html_e('Password','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="confirm_pass" <?php if (isset($str) && $str == 'confirm_pass') echo 'selected'; ?>><?php esc_html_e('Confirm Password','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="description" <?php if (isset($str) && $str == 'description') echo 'selected'; ?>><?php esc_html_e('Biographical Info','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="user_avatar" <?php if (isset($str) && $str == 'user_avatar') echo 'selected'; ?>><?php esc_html_e('Profile Image','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="mobile_number" <?php if (isset($str) && $str == 'mobile_number') echo 'selected'; ?>><?php esc_html_e('Mobile Number','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="phone_number" <?php if (isset($str) && $str == 'phone_number') echo 'selected'; ?>><?php esc_html_e('Phone Number','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="gender" <?php if (isset($str) && $str == 'gender') echo 'selected'; ?>><?php esc_html_e('Gender','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="language" <?php if (isset($str) && $str == 'language') echo 'selected'; ?>><?php esc_html_e('Language','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <!--<option value="birth_date" <?php if (isset($str) && $str == 'birth_date') echo 'selected'; ?>><?php esc_html_e('Birth Date','profilegrid-user-profiles-groups-and-communities'); ?></option> -->
                        <option value="divider" <?php if (isset($str) && $str == 'divider') echo 'selected'; ?>><?php esc_html_e('Divider','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="spacing" <?php if (isset($str) && $str == 'spacing') echo 'selected'; ?>><?php esc_html_e('Spacing','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="multi_dropdown" <?php if (isset($str) && $str == 'multi_dropdown') echo 'selected'; ?>><?php esc_html_e('Multi Dropdown','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="facebook" <?php if (isset($str) && $str == 'facebook') echo 'selected'; ?>><?php esc_html_e('Facebook','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="twitter" <?php if (isset($str) && $str == 'twitter') echo 'selected'; ?>><?php esc_html_e('Twitter','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="google" <?php if (isset($str) && $str == 'google') echo 'selected'; ?>><?php esc_html_e('Google+','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="linked_in" <?php if (isset($str) && $str == 'linked_in') echo 'selected'; ?>><?php esc_html_e('Linked In','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="youtube" <?php if (isset($str) && $str == 'youtube') echo 'selected'; ?>><?php esc_html_e('Youtube','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="mixcloud" <?php if (isset($str) && $str == 'mixcloud') echo 'selected'; ?>><?php esc_html_e('MixCloud','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="soundcloud" <?php if (isset($str) && $str == 'soundcloud') echo 'selected'; ?>><?php esc_html_e('SoundCloud','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="instagram" <?php if (isset($str) && $str == 'instagram') echo 'selected'; ?>><?php esc_html_e('Instagram','profilegrid-user-profiles-groups-and-communities'); ?></option>
...
<?php esc_html_e('Heading Tag:','profilegrid-user-profiles-groups-and-communities'); ?>
                    ...
                    <div class="uiminput">
                        <select name="field_options[heading_tag]" id="heading_tag">
                            <option value="h1" <?php if (!empty($field_options)) selected($field_options['heading_tag'], 'h1'); ?>><?php esc_html_e('Heading 1','profilegrid-user-profiles-groups-and-communities'); ?></option>
                            <option value="h2" <?php if (!empty($field_options)) selected($field_options['heading_tag'], 'h2'); ?>><?php esc_html_e('Heading 2','profilegrid-user-profiles-groups-and-communities'); ?></option>
                            <option value="h3" <?php if (!empty($field_options)) selected($field_options['heading_tag'], 'h3'); ?>><?php esc_html_e('Heading 3','profilegrid-user-profiles-groups-and-communities'); ?></option>
                            <option value="h4" <?php if (!empty($field_options)) selected($field_options['heading_tag'], 'h4'); ?>><?php esc_html_e('Heading 4','profilegrid-user-profiles-groups-and-communities'); ?></option>
                            <option value="h5" <?php if (!empty($field_options)) selected($field_options['heading_tag'], 'h5'); ?>><?php esc_html_e('Heading 5','profilegrid-user-profiles-groups-and-communities'); ?></option>
                            <option value="h6" <?php if (!empty($field_options)) selected($field_options['heading_tag'], 'h6'); ?>><?php esc_html_e('Heading 6','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        </select>
                    </div>
...
<?php esc_html_e('Price:','profilegrid-user-profiles-groups-and-communities'); ?>
                ...
                <div class="uimrow" id="video_width_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[video_width]" id="video_width" value="<?php if (!empty($field_options)) echo esc_attr($field_options['video_width']);  if($id==0){echo '640';} ?>" />
                    </div>
                 ...
                 <div class="uimrow" id="video_height_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[video_height]" id="video_height" value="<?php if (!empty($field_options)) echo esc_attr($field_options['video_height']); if($id==0){echo '360';} ?>" />
                    </div>
                ...
                <div class="uimrow" id="video_frame_border_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[video_frame_border]" id="video_frame_border" value="<?php if (!empty($field_options)) echo esc_attr($field_options['video_frame_border']); if($id==0){echo '0';} ?>" />
                    </div>
                ...
                <div class="uimrow" id="video_auto_play_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[video_auto_play]" id="video_auto_play" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['video_auto_play'])) checked($field_options['video_auto_play'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow" id="video_player_control_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[video_player_control]" id="video_player_control" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['video_player_control'])){ checked($field_options['video_player_control'], 1);} if($id==0){echo 'checked';} ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow" id="video_fullscreen_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[video_fullscreen]" id="video_fullscreen" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['video_fullscreen'])){ checked($field_options['video_fullscreen'], 1);} if($id==0){echo 'checked';} ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow" id="video_loop_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[video_loop]" id="video_loop" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['video_loop'])){ checked($field_options['video_loop'], 1);} ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_width_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[mixcloud_width]" id="mixcloud_width" value="<?php if (!empty($field_options)) echo esc_attr($field_options['mixcloud_width']); if($id==0){echo '640';} ?>" />
                    </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_height_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[mixcloud_height]" id="mixcloud_height" value="<?php if (!empty($field_options)) echo esc_attr($field_options['mixcloud_height']); if($id==0){echo '360';} ?>" />
                    </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_frame_border_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[mixcloud_frame_border]" id="mixcloud_frame_border" value="<?php if (!empty($field_options)) echo esc_attr($field_options['mixcloud_frame_border']); if($id==0){echo '0';} ?>" />
                    </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_auto_play_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[mixcloud_auto_play]" id="mixcloud_auto_play" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['mixcloud_auto_play'])) checked($field_options['mixcloud_auto_play'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                 ...
                 <div class="uimrow mixcloud_html" id="mixcloud_hide_cover_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[mixcloud_hide_cover]" id="mixcloud_hide_cover" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['mixcloud_hide_cover'])) checked($field_options['mixcloud_hide_cover'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_hide_tracklist_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[mixcloud_hide_tracklist]" id="mixcloud_hide_tracklist" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['mixcloud_hide_tracklist'])) checked($field_options['mixcloud_hide_tracklist'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                 ...
                 <div class="uimrow mixcloud_html" id="mixcloud_hide_artwork_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[mixcloud_hide_artwork]" id="mixcloud_hide_artwork" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['mixcloud_hide_artwork'])) checked($field_options['mixcloud_hide_artwork'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                 ...
                 <div class="uimrow mixcloud_html" id="mixcloud_mini_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[mixcloud_mini]" id="mixcloud_mini" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['mixcloud_mini'])) checked($field_options['mixcloud_mini'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_light_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[mixcloud_light]" id="mixcloud_light" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['mixcloud_light'])) checked($field_options['mixcloud_light'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_width_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[soundcloud_width]" id="soundcloud_width" value="<?php if (!empty($field_options)) echo esc_attr($field_options['soundcloud_width']); if($id==0){echo '640';} ?>" />
                    </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_height_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[soundcloud_height]" id="soundcloud_height" value="<?php if (!empty($field_options)) echo esc_attr($field_options['soundcloud_height']); if($id==0){echo '360';} ?>" />
                    </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_frame_border_html">
                    ...
                    <div class="uiminput">
                        <input type="number" min="0" name="field_options[soundcloud_frame_border]" id="soundcloud_frame_border" value="<?php if (!empty($field_options)) echo esc_attr($field_options['soundcloud_frame_border']); if($id==0){echo '0';} ?>" />
                    </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_auto_play_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_auto_play]" id="soundcloud_auto_play" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_auto_play'])) checked($field_options['soundcloud_auto_play'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_play_button_color_html">
                    ...
                    <div class="uiminput">
                        <input type="text" name="field_options[soundcloud_play_button_color]" id="soundcloud_play_button_color" class="soundcloud_play_button_color" value="<?php if (!empty($field_options)) echo esc_attr($field_options['soundcloud_play_button_color']); ?>" />
                    </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_buy_button_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_buy_button]" id="soundcloud_buy_button" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_buy_button'])) checked($field_options['soundcloud_buy_button'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_share_button_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_share_button]" id="soundcloud_share_button" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_share_button'])) checked($field_options['soundcloud_share_button'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_download_button_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_download_button]" id="soundcloud_download_button" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_download_button'])) checked($field_options['soundcloud_download_button'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_show_artwork_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_show_artwork]" id="soundcloud_show_artwork" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_show_artwork'])) checked($field_options['soundcloud_show_artwork'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_show_playcount_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_show_playcount]" id="soundcloud_show_playcount" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_show_playcount'])) checked($field_options['soundcloud_show_playcount'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_show_user_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_show_user]" id="soundcloud_show_user" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_show_user'])) checked($field_options['soundcloud_show_user'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_single_active_html">
                    ...
                    <div class="uiminput">
                        <input name="field_options[soundcloud_single_active]" id="soundcloud_single_active" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($field_options['soundcloud_single_active'])) checked($field_options['soundcloud_single_active'], 1); ?> style="display:none;" onclick="pm_show_hide(this)" />
                ...
                <div class="uiminput pm_select_required">
                    <select name="associate_group" id="associate_group" onchange="pm_ajax_sections_dropdown(this.value)">
                        ...
                        foreach ($groups as $group) {
                            ?>
                            <option value="<?php echo esc_attr($group->id); ?>" <?php if (!empty($gid)) selected($gid, $group->id); ?>><?php echo esc_html($group->group_name); ?></option>
<?php }
?>
                    </select>
                    <div class="errortext"></div>
                ...
                <div class="uiminput pm_select_required">
                    <select name="associate_section" id="associate_section">
                        ...
                        foreach ($sections as $section) {
                            ?>
                        <option value="<?php echo esc_attr($section->id); ?>" <?php if (!empty($row)) selected($row->associate_section, $section->id); ?>><?php echo esc_html($section->section_name); ?></option>
<?php }
?>
                    </select>
                    <div class="errortext"></div>
...
<?php esc_html_e('Display on Group Page','profilegrid-user-profiles-groups-and-communities'); ?>
            ...
            <div class="uimrow" id="default_registration_form_heading" <?php if (!empty($field_options['admin_only']) && $field_options['admin_only']==1) echo 'style="display:none;"'; ?>>
            <h3><?php esc_html_e('Default Registration Form','profilegrid-user-profiles-groups-and-communities');?></h3>
            </div>

            <div class="uimrow" id="show_signup" <?php if (!empty($field_options['admin_only']) && $field_options['admin_only']==1) {echo 'style="display:none"';} ?>>
                <div class="uimfield">
...
<?php esc_html_e('Required?','profilegrid-user-profiles-groups-and-communities'); ?>
            ...
            <div class="uimrow" id="privacy" <?php if (!empty($field_options['admin_only']) && $field_options['admin_only']==1) echo 'style="display:none;"'; ?>>
                    <div class="uimfield">
...
<?php esc_html_e('Start Year','profilegrid-user-profiles-groups-and-communities'); ?>
                        ...
                        <div class="uiminput">
                            <input type="text" class="pm_calendar" value="<?php if (!empty($field_options['max_dob'])) echo esc_attr($field_options['max_dob']); ?>" id="max_dob" name="field_options[max_dob]" />
...
<?php esc_html_e('End Year','profilegrid-user-profiles-groups-and-communities'); ?>
                        ...
                        <div class="uiminput">
                            <input type="text" class="pm_calendar" value="<?php if (!empty($field_options['min_dob'])) echo esc_attr($field_options['min_dob']); ?>" id="min_dob" name="field_options[min_dob]" />
...
<?php esc_html_e('Allow fields','profilegrid-user-profiles-groups-and-communities'); ?>
                ...
                <div class="uiminput">
                    <ul class="uimradio">
                        <li>  
                            <input type="checkbox" name="field_options[address_line_1]" value="1" <?php if (!empty($field_options['address_line_1'])) echo 'checked'; ?>> <?php esc_html_e('Address line 1','profilegrid-user-profiles-groups-and-communities');?> 
                        </li>
                        <li>
                            <input type="checkbox" name="field_options[address_line_2]" value="1" <?php if (!empty($field_options['address_line_2'])) echo 'checked'; ?>> <?php esc_html_e('Address line 2','profilegrid-user-profiles-groups-and-communities');?>
                        </li>
                        <li>
                            <input type="checkbox" name="field_options[city]" value="1" <?php if (!empty($field_options['city'])) echo 'checked'; ?>> <?php esc_html_e('City','profilegrid-user-profiles-groups-and-communities');?>    
                        </li>
                        <li>
                            <input type="checkbox" name="field_options[state]" value="1" <?php if (!empty($field_options['state'])) echo 'checked'; ?>> <?php esc_html_e('State','profilegrid-user-profiles-groups-and-communities');?> 
                        </li>
                         <li>
                            <input type="checkbox" name="field_options[country]" value="1" <?php if (!empty($field_options['country'])) echo 'checked'; ?>> <?php esc_html_e('Country','profilegrid-user-profiles-groups-and-communities');?> 
                        </li> 
                        <li>
                            <input type="checkbox" name="field_options[zip_code]" value="1" <?php if (!empty($field_options['zip_code'])) echo 'checked'; ?>> <?php esc_html_e('Zip Code','profilegrid-user-profiles-groups-and-communities');?>
                        </li>
                    </ul>
            ...
            <div class="" id="pg_rm_field_html" <?php if (!empty($field_options['admin_only']) && $field_options['admin_only']==1) echo 'style="display:none;"'; ?>>
            <div class="uimrow">
