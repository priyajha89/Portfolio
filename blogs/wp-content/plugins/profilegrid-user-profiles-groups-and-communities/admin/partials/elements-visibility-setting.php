...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_elements_visibility_settings' ) ) die( esc_html__('Failed security check','profilegrid-user-profiles-groups-and-communities') );
	$exclude = array("_wpnonce","_wp_http_referer","submit_settings");
	$post = $pmrequests->sanitize_request($_POST,$identifier,$exclude);
	if($post!=false)
	{
            if(!isset($post['pm_show_profile_cover_image'])) $post['pm_show_profile_cover_image'] = 0;
            if(!isset($post['pm_show_change_profile_cover_image_option'])) $post['pm_show_change_profile_cover_image_option'] = 0;
            if(!isset($post['pm_show_profile_image'])) $post['pm_show_profile_image'] = 0;
            if(!isset($post['pm_show_change_profile_image_option'])) $post['pm_show_change_profile_image_option'] = 0;
            if(class_exists('Profilegrid_Profile_Labels'))
            {
                if(!isset($post['pm_show_profile_tags'])) $post['pm_show_profile_tags'] = 0;
            }
            if(!isset($post['pm_show_user_group_badges'])) $post['pm_show_user_group_badges'] = 0;
            if(!isset($post['pm_show_user_display_name'])) $post['pm_show_user_display_name'] = 0;
            if(!isset($post['pm_show_user_group_name'])) $post['pm_show_user_group_name'] = 0;
            if(!isset($post['pm_show_user_edit_profile_button'])) $post['pm_show_user_edit_profile_button'] = 0;
            if(!isset($post['pm_show_user_left_menu'])) $post['pm_show_user_left_menu'] = 0;
            if(!isset($post['pm_show_user_email'])) $post['pm_show_user_email'] = 0;
            if(!isset($post['pm_show_user_new_blog_post_button'])) $post['pm_show_user_new_blog_post_button'] = 0;
            if(!isset($post['pm_show_user_blog_post_time'])) $post['pm_show_user_blog_post_time'] = 0;
            if(!isset($post['pm_show_user_blog_post_comment_count'])) $post['pm_show_user_blog_post_comment_count'] = 0;
            if(!isset($post['pm_show_user_blog_post_thumbnail'])) $post['pm_show_user_blog_post_thumbnail'] = 0;
            if(!isset($post['pm_show_notification_view_links'])) $post['pm_show_notification_view_links'] = 0;
            if(!isset($post['pm_show_notification_title_links'])) $post['pm_show_notification_title_links'] = 0;
            if(!isset($post['pm_show_user_group_title_links'])) $post['pm_show_user_group_title_links'] = 0;
            if(!isset($post['pm_show_user_group_card_menu'])) $post['pm_show_user_group_card_menu'] = 0;
            if(!isset($post['pm_show_group_card_menu_group_page'])) $post['pm_show_group_card_menu_group_page'] = 0;
            if(!isset($post['pm_show_group_card_menu_group_wall'])) $post['pm_show_group_card_menu_group_wall'] = 0;
            if(!isset($post['pm_show_group_card_menu_group_photos'])) $post['pm_show_group_card_menu_group_photos'] = 0;
            if(!isset($post['pm_show_group_card_menu_leave_group'])) $post['pm_show_group_card_menu_leave_group'] = 0;
            
            if(!isset($post['pm_show_group_card'])) $post['pm_show_group_card'] = 0;
            if(!isset($post['pm_show_group_leave_group_button'])) $post['pm_show_group_leave_group_button'] = 0;
            if(!isset($post['pm_show_group_managers_field'])) $post['pm_show_group_managers_field'] = 0;
            if(!isset($post['pm_show_group_members_field'])) $post['pm_show_group_members_field'] = 0;
            if(!isset($post['pm_show_group_details'])) $post['pm_show_group_details'] = 0;
            if(!isset($post['pm_show_group_members_tab'])) $post['pm_show_group_members_tab'] = 0;
            if(!isset($post['pm_show_group_discussions_tab'])) $post['pm_show_group_discussions_tab'] = 0;
            if(!isset($post['pm_show_group_photos_tab'])) $post['pm_show_group_photos_tab'] = 0;
            if(!isset($post['pm_show_group_settings_tab'])) $post['pm_show_group_settings_tab'] = 0;
            if(!isset($post['pm_show_group_settings_subtab_group'])) $post['pm_show_group_settings_subtab_group'] = 0;
            if(!isset($post['pm_show_group_settings_subtab_members'])) $post['pm_show_group_settings_subtab_members'] = 0;
            if(!isset($post['pm_show_group_settings_subtab_blog'])) $post['pm_show_group_settings_subtab_blog'] = 0;
            if(class_exists('Profilegrid_Group_Multi_Admins')):
                if(!isset($post['pm_show_group_settings_subtab_group_manager'])) $post['pm_show_group_settings_subtab_group_manager'] = 0;
            endif;
            if(!empty($groups))
            {
                foreach($groups as $group)
                {
                    ...
                    if(!isset($post[$option_name])) $post[$option_name] = 0;
                }
            }
  ...
  <form name="pm_elements_visibility_settings" id="pm_elements_visibility_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimrow">
       ...
       <div class="childfieldsrow" id="enable_profile_cover_image_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_profile_cover_image',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
      <div class="uimrow">
        <div class="uimfield">
       ...
       <div class="childfieldsrow" id="enable_profile_image_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_profile_image',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
      <div class="uimrow">
        <div class="uimfield">
...
<!--        <div class="uimrow">
       ...
       <div class="uimrow">
        ...
        <div class="childfieldsrow" id="enable_profile_group_card_menu_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_user_group_card_menu',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
        ...
        <div class="childfieldsrow" id="enable_group_card_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_group_card',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
      ...
      <?php endif; ?>
        ...
        <div class="childfieldsrow" id="enable_group_settings_tab_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_group_settings_tab',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
...
<div class="pg-admin-element-group-wrap">
        ...
        if(!empty($groups))
        {
            ...
            foreach($groups as $group)
            {
                ...
                <?php 
                if($col && !($col%3)){echo '</div><div class="pg-admin-element-group-row">';}
                $option_name = 'pm_show_group_on_groups_page_'.$group->id;
                ?>
