...
if(filter_input(INPUT_POST,'submit_tmpl'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_pm_add_email_tmpl' ) ) die(esc_html__('Failed security check','profilegrid-user-profiles-groups-and-communities') );
	...
	wp_safe_redirect( esc_url_raw('admin.php?page=pm_email_templates') );exit;
}
?>
<div class="uimagic">
