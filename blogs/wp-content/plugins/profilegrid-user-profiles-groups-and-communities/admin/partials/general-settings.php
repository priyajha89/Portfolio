...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_general_settings' ) ) die( esc_html__('Failed security check','profilegrid-user-profiles-groups-and-communities') );
	...
	if($post!=false)
	{
		...
		if(!isset($post['pm_enable_gravatars'])) $post['pm_enable_gravatars']=0;
                if(!isset($post['pm_show_register_link'])) $post['pm_show_register_link']=0;
	...
	wp_safe_redirect( esc_url_raw('admin.php?page=pm_settings') );exit;
}
    ...
    <div class="childfieldsrow" id="pm_reset_password_limt_html" style=" <?php if($dbhandler->get_global_option_value('pm_enable_reset_password_limit',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
      ...
      <div class="uimrow">
	   ...
	   $pm_groups_page = $dbhandler->get_global_option_value('pm_groups_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_groups_page,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
			'name'=>'pm_groups_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
      ...
      <div class="uimrow">
	   ...
	   $pm_registration_page = $dbhandler->get_global_option_value('pm_registration_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_registration_page,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
      ...
      <div class="uimrow">
	   ...
	   $pm_user_profile_page = $dbhandler->get_global_option_value('pm_user_profile_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_user_profile_page,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
      ...
      <div class="uimrow">
        ...
        <?php 
			...
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_user_login_page,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
      ...
      <div class="uimrow">
        ...
        <?php 
			...
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_forget_password_page,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
      ...
      <div class="uimrow">
        ...
        <?php 
			...
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_group_page,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
			'name'=>'pm_group_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        ...
        <div class="uimrow">
            ...
            <?php 
                            ...
                            $args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_submit_blog,'echo'=>1,'show_option_none'=>esc_attr__('Select Page','profilegrid-user-profiles-groups-and-communities'),'option_none_value'=>0,
                            'name'=>'pm_submit_blog');
                            wp_dropdown_pages($args); 
                    ?>
              <div class="errortext"></div>
