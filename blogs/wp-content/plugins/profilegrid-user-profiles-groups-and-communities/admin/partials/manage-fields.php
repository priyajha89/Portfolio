 ...
 <div class="pm-group-fields-popup-wrap pm-group-fields-popup-out">
    ...
    <div class="pmagic"> 
        ...
        <div class="operationsbar">
            ...
            <div class="icons"><a href="admin.php?page=pm_add_group&id=<?php echo esc_attr($gid); ?>"><img src="<?php echo esc_url($path.'images/global-settings.png');?>"></a></div>
            <div class="nav">
                <ul>
            ...
            <ul class="pm-page-tabs-sidebar field-tabs pm_sortable_tabs">
                ...
                if (isset($sections)):
                    foreach ($sections as $section):
                        ...
                        <?php esc_html_e($section->section_name,'profilegrid-user-profiles-groups-and-communities'); ?>
                            </a> </li>
    <?php endforeach;
endif; ?>
...
<?php wp_nonce_field('save_pm_add_section'); ?>
    ...
    <div class="pg-uim-notice-wrap">
        <div class="pg-uim-notice"><?php esc_html_e('There’s no password field in your sign up form. You can auto-generated and email password to registering users. To do that please add password field to Account Activation email template associated with this Group.','profilegrid-user-profiles-groups-and-communities'); ?></div>
    </div>
<?php endif;