...
<div id="pg-wizard-modal" class="pm-wizard-modal">
   ...
   <div class="pg-wizard-step-box-wrap">
    ...
    <div class="pg-wizard-step-header"><span class="pg-steps-header-userinfo"><span class="pg-steps-header-img"><?php echo get_avatar($user->user_email,40,'',false,array('class'=>'pm-user','force_display'=>true));?></span> <span class="pg-steps-header-name"><?php esc_html_e('Hello','profilegrid-user-profiles-groups-and-communities');?> <strong><?php echo wp_kses_post($displayname);?></strong><span></span></div>

       <div class="pg-wizard-container">
         
         <form name="pm_add_group" class="pg-wizard-steps-panel" id="pm_add_group" method="post"  action="<?php echo admin_url( 'admin-ajax.php' );?>">
                 ...
                 <div class="pg-wzard-row">
                     <div class="pg-wzard-field-wrap">
                         ...
                         <div class="pg-wzrad-input pm_required">
                             <input type="text" name="group_name" id="group_name" value="<?php if (!empty($row)) echo esc_attr($row->group_name); ?>" onkeyup="change_wizard_group_name(this.value)" />
               ...
               <div class="pg-wzrad-step pg-wizard-step-2">
                   <div class="pg-group-type-wrap">
                       ...
                       <label class="pg-group-type pg-open-group" for="group_type_open">
                           <input checked type="radio" name="group_options[group_type]" id="group_type_open" value="open" <?php if(!empty($group_options) && isset($group_options['group_type']) && $group_options['group_type']=='open'){ echo "checked";}?> onclick="change_wizard_group_type(this.value)">
                       ...
                       <label class="pg-group-type pg-close-group" for="group_type_close">
                           <input type="radio" id="group_type_close" name="group_options[group_type]" value="closed" <?php if(!empty($group_options) && isset($group_options['group_type']) && $group_options['group_type']=='closed'){ echo "checked";}?> onclick="change_wizard_group_type(this.value)">
                           <div class="pg-group-type-content">
              ...
              <div class="pg-wzrad-step pg-wizard-step-3">
                 ...
                 <div class="pg-wzard-row">
                     <div class="pg-wzard-field-wrap">
                         <div class="pg-wzrad-field">
                           ...
                           <div class="pg-wzrad-input">
                        <textarea name="success_message" id="success_message" ><?php if(!empty($row))echo esc_attr($row->success_message); ?></textarea>
                             <div class="errortext"></div>
                         </div>
               ...
               <div class="pg-wzrad-step pg-wizard-step-4">
                   <div class="pg-group-type-wrap">
                       ...
                       <label class="pg-group-type pg-open-group" for="is_free_group">
                           <input type="radio" name="group_options[is_paid_group]" id="is_free_group" onClick="show_hide_wizard(this,'paidgrouphtml')" value="0" <?php if(!empty($group_options) && isset($group_options['is_paid_group']) && $group_options['is_paid_group']==1){ echo "checked";}?>>
                           <div class="pg-group-type-content">
                       ...
                       <label class="pg-group-type pg-close-group" for="is_paid_group">
                           <input name="group_options[is_paid_group]" id="is_paid_group" type="radio" value="1" onClick="show_hide_wizard(this,'paidgrouphtml')" <?php if(!empty($group_options) && isset($group_options['is_paid_group']) && $group_options['is_paid_group']==1){ echo "checked";}?>/>
                        ...
                        <div class="pg-wzard-row" id="paidgrouphtml" style=" <?php if(!empty($group_options) && isset($group_options['is_paid_group']) && $group_options['is_paid_group']==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
                     <div class="pg-wzard-field-wrap">
                         <div class="pg-wzrad-field">
                            <?php esc_html_e( 'Group Membership Fee','profilegrid-user-profiles-groups-and-communities' ); ?>
                         </div>
                         <div class="pg-wzrad-input <?php if(!empty($group_options) && isset($group_options['is_paid_group']) && $group_options['is_paid_group']==1){echo 'pm_required';}?>">
                             <input type="number" min="0" name="group_options[group_price]" id="group_price" value="<?php if(!empty($group_options) && isset($group_options['group_price']))echo $group_options['group_price'];?>" />
                            <div class="errortext"></div>
                          </div>
                 ...
                 <div class="pg-wizard-footer">
                     <input type="hidden" name="group_id" id="group_id" value="<?php if(!empty($row)) echo esc_attr($row->id); ?>" />
               ...
               <div class="pg-wzrad-step pg-wizard-step-5">                 
                     <div class="pg-wzard-field-wrap pg-wzard-final-slide-wrap">
                         <div class="pg-wzard-final-title"><strong><?php esc_html_e('Congratulations','profilegrid-user-profiles-groups-and-communities');?></strong>, <?php esc_html_e('your new default user group','profilegrid-user-profiles-groups-and-communities');?> <strong> <?php if(!empty($row)) echo esc_attr($row->group_name); ?></strong> <?php esc_html_e('is now ready!','profilegrid-user-profiles-groups-and-communities');?></div>
   ...
   <div class="pg-wizard-steps-ready">
       ...
       <div class="pg-wizard-group-wrap">
           <div class="pg-wizard-group">
               <div class="pg-wizard-group-title"><span class="pg-wizard-group-title-span"><?php if(!empty($row)) echo esc_attr($row->group_name); ?></span>
                   <div class="pg-wizard-group-status-tag"><span class="pg-wizard-group-type-span"><?php  if(isset($group_options['group_type'])){echo esc_html($group_options['group_type']);}else{ echo 'open';}?></span></div>
               </div>
         ...
         <div class="uiminput" id="icon_html">
          ...
          <input id="wizard_group_id" type="hidden" name="wizard_group_id" class="wizard_group_id" value="<?php if(!empty($row)) echo esc_attr($row->id); ?>" />
          
          <div class="pm-group-logo-img">
                        <?php echo $pmrequests->profile_magic_get_group_icon($row,'wizard_group_icon_button'); ?>
                        </div>
          ...
          <div class="errortext" id="icon_error"></div>
               ...
               <div class="pg-wizard-group-description"><?php if(!empty($row)) echo esc_attr($row->group_desc); ?></div>
