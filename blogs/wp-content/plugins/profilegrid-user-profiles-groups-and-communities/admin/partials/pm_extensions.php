<?php
wp_enqueue_script( 'pg-extensions-js');
/* 
        ...
        <div class="pg_pr_content">     
            <div class="pg_pr_row pg_pr_row-wrap">              
                   <div class="pg_pr_pitch_title">
                       <?php esc_html_e('Welcome to the most versatile community builder for WordPress','profilegrid-user-profiles-groups-and-communities');?>
                    
                    </div>
                <div class="pg_pr_block_left">
                    <div class="pg_pitch_details">
                        <?php esc_html_e('You can purchase and download individual extensions, or you can own all extensions as part of one massively discounted Premium extensions bundle.','profilegrid-user-profiles-groups-and-communities');?>
                       
                    </div>
                    <div class="pg_pr_row pg_pitch_action_button">
                    <a href="<?php echo esc_url($url); ?>" target="_blank"><button class="pg_pr_action"><?php esc_html_e('Get Premium','profilegrid-user-profiles-groups-and-communities');?> </button></a>
                </div>
                ...
                <div class="pg_pr_block_right">
                    ...
                    <div class="pg-pr-cards-wrap">
                        ...
                        <img src="<?php echo esc_url($path.'images/pg-card-1.png');?>" class="aligncenter" alt="img" title="ProfileGrid">
                        </div> 
                        
                          <div class="pg-pr-card pg-pr-card-2"> 
                         <img src="<?php echo esc_url($path.'images/pg-card-6.png');?>" class="aligncenter" alt="img" title="ProfileGrid">                        </div> 
                        
                          <div class="pg-pr-card pg-pr-card-3"> 
                        <img src="<?php echo esc_url($path.'images/pg-card-5.png');?>" class="aligncenter" alt="img" title="ProfileGrid">
                        </div> 
                        
                        
                         <div class="pg-cards-slider" id="pg-cards-slider">
                            <div class="pg-cards-wrapper">
                                <img src="<?php echo esc_url($path.'images/pg-card-1.png');?>" alt="First" class="pg-card-slide" /> 
                                <img src="<?php echo esc_url($path.'images/pg-card-2.png');?>" alt="Second" class="pg-card-slide" />
                                <img src="<?php echo esc_url($path.'images/pg-card-3.png');?>" alt="Third" class="pg-card-slide" />
                                <img src="<?php echo esc_url($path.'images/pg-card-4.png');?>" alt="fourth" class="pg-card-slide" /> 
                                <img src="<?php echo esc_url($path.'images/pg-card-5.png');?>" alt="five" class="pg-card-slide" />
                                <img src="<?php echo esc_url($path.'images/pg-card-6.png');?>" alt="six" class="pg-card-slide" />
                            </div>
                         </div>
    ...
    <div class="pg-scblock "> 
        ...
        <div class="pg_pr_row">
          ...
          <div class="pg_pr_banner-title">
              <?php esc_html_e('Ready to Scale-up Your User Profiles to the Next Level ?','profilegrid-user-profiles-groups-and-communities');?>         </div>
