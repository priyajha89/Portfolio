...
<h2 class="nav-tab-wrapper" id="pg-promo-tabs">
    <a href="javascript:void(0)" id="tab1" class="nav-tab nav-tab-active"> <?php esc_html_e('Profile Labels','');?> </a>
    <a href="javascript:void(0)" id="tab2" class="nav-tab"><?php esc_html_e('Custom Tabs List','');?> </a>
    </h2>
</div>
...
<?php if(!class_exists('Profilegrid_Profile_Labels')):?>
    ...
    <div class="pg-upgrade-banner">        
        <div class="pg-upgrade-banner-title"><?php esc_html_e('This is a preview of pages added to ProfileGrid when you upgrade to Premium Bundle.','');?><span><a href="admin.php?page=pm_extensions" target="_blank"><?php esc_html_e('More Info','');?></a></span></div>
