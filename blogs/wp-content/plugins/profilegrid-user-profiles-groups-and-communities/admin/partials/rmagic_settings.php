...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_message_settings' ) ) die(esc_html__('Failed security check','profilegrid-user-profiles-groups-and-communities') );
    ...
    <div class="content">
      ...
      <div class="uimrow">
       ...
       <!-----Inbox Tab----->
        ...
        <div class="uiminput">
            <input name="pm_enable_rm_inbox_tab" id="pm_enable_rm_inbox" type="checkbox" <?php checked($dbhandler->get_global_option_value('pm_enable_rm_inbox_tab','0'),'1'); ?> class="pm_toggle" value="1" style="display:none;" onClick="pm_show_hide(this,'pm_rm_inbox_title')" <?php if (!defined('REGMAGIC_GOLD') || !defined('RM_ADDON_PLUGIN_VERSION') ) echo 'disabled="disabled"';  ?>/>
