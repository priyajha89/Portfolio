...
class PM_HTML_Creator
{
	...
	public function get_custom_fields_html_singlepage($gid,$fields,$col=1,$value='')
	{
        ...
        else{$exclude = "and field_type not in('read_only')";}
	...
	public function get_group_page_fields_html($uid,$gid,$group_leader,$imgsize='',$arg='',$hide_profile_link='')
	{
        ...
        <div class="pm-user-card pm-difl pm-border pm-radius5">
            <div class="pm-user-card-cover pm-dbfl">
                <?php 
          echo wp_kses_post($pmrequests->profile_magic_get_cover_image($uid,$imgsize,'',false,$arg));?></div>
			...
			<div class="pm-user-description-row pm-dbfl pm-border">
                            ...
                            switch($field->field_type)
                            {
                                case 'youtube':
                                    ...
                                    $youtube_id = $match[1];
                                   ?> 
                                    <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_'.$field->field_type; ?>">
                                        <iframe style="border:<?php if(isset($field_options['video_frame_border'])){ echo esc_attr($field_options['video_frame_border'].'px solid');} ?>" frameborder="<?php if(isset($field_options['video_frame_border'])){echo esc_attr($field_options['video_frame_border']);}?>" width="<?php echo ($field_options['video_width']!='')?$field_options['video_width']:640;?>" height="<?php echo ($field_options['video_height']!='')?$field_options['video_height']:360;?>" type="text/html" src="https://www.youtube.com/embed/<?php echo esc_attr($youtube_id);?>?mute=1&autoplay=<?php echo (isset($field_options['video_auto_play']) && $field_options['video_auto_play']=='1')?'1':'0';?>&fs=<?php echo (isset($field_options['video_fullscreen']) && $field_options['video_fullscreen']=='1')?'1':'0';?>&controls=<?php echo (isset($field_options['video_player_control']) && $field_options['video_player_control']=='1')?'1':'0';?>&loop=<?php echo (isset($field_options['video_loop']) && $field_options['video_loop']=='1')?'1&playlist='.$youtube_id:'0';?>" allowfullscreen allowautoplay></iframe>
                                    </div>
                                    <?php 
                                break;
                                ...
                                case 'mixcloud':
                                    ...
                                    $feed = urlencode(substr($value,strpos($value, "mixcloud.com")+12 )); 
                                    
                                   ?> 
                                    <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_'.$field->field_type; ?>">
                                        <iframe style="border:<?php echo esc_attr($field_options['mixcloud_frame_border'].'px solid'); ?>" width="<?php echo ($field_options['mixcloud_width']!='')?$field_options['mixcloud_width']:640;?>" height="<?php echo ($field_options['mixcloud_height']!='')?$field_options['mixcloud_height']:360;?>" src="https://www.mixcloud.com/widget/iframe/?hide_cover=<?php if(isset($field_options['mixcloud_hide_cover'])){ echo esc_attr($field_options['mixcloud_hide_cover']);}?>&light=<?php if(isset($field_options['mixcloud_light'])){ echo esc_attr($field_options['mixcloud_light']);}?>&mini=<?php if(isset($field_options['mixcloud_mini'])){ echo esc_attr($field_options['mixcloud_mini']);}?>&hide_artwork=<?php if(isset($field_options['mixcloud_hide_artwork'])){ echo esc_attr($field_options['mixcloud_hide_artwork']);}?>&autoplay=<?php if(isset($field_options['mixcloud_auto_play'])) {echo esc_attr($field_options['mixcloud_auto_play']);}?>&feed=<?php echo esc_attr($feed);?>" frameborder="<?php echo esc_attr($field_options['mixcloud_frame_border']);?>" allow="autoplay"></iframe>
                                    </div>
                                    <?php 
                                break;
                                ...
                                case 'instagram':
                                    ?> 
                                    <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_'.$field->field_type; ?>"><a href="<?php echo esc_url($value);?>" target="_blank"><?php echo wp_kses_post($value);?></a></div>
                                    <?php
                                    break;
                                default:
                                    ?>
                                    <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_'.$field->field_type; ?>"><?php echo wp_kses_post($value);?></div>
                                    <?php
                                    break;
                    ...
                    <div class="pm-blog-post-wrap pm-dbfl">
                         ...
                         <div class="pm-blog-img-wrap pm-difl">
                            ...
                            <?php
                             ...
                             {
                                 ?><div class="pm-blog-img pm-no-blog-img pm-difl"></div> <?php
                             }
                            ?>
                         ...
                         {
                             ?><div class="pm-blog-img-wrap pm-no-blog-img-wrap pm-difl"></div> <?php
                         }
...
<div class="pm-section-right-panel">
            <div class="pm-blog-desc-wrap pm-difl pm-section-content pm-message-thread-section">
                ...
                <div  class="pm-user-display-area pm-dbfl ">
                    ...
                    <input type="hidden" id="receipent_field_rid" name="rid" value="<?php if(isset($receiver_user)) echo esc_attr($receiver_user['uid']); ?>"  />   
                    </div></div>
             ...
             <div class="pmrow">
               <div class="pg-users-send-box pm-dbfl">        
                    ...
                    <div class="pm-field-input pm_required pm-difl">
                          <input title="Enter your title" type="text" class="" maxlength="" value="<?php if(isset($post)){echo esc_attr($post->post_title);}?>" id="blog_title" name="blog_title" placeholder="">
                          <div class="errortext" style="display:none;"></div>
                    </div>
    ...
    print_footer_scripts();
        ...
        <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ));?>" method="post" name="pg_add_admin_note" id="pg_add_admin_note">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                ...
                <div class="pg-users-send-box pm-dbfl">        
                        ...
                        <div class="pm-field-input pm-difl">
                            <textarea name="pm_admin_note_content" id="pm_admin_note_content" maxlength="5000" size="5000" onkeyup="pg_count_left_charactors('pm_admin_note_content','pg_text_counter','{CHAR} <?php esc_html_e('characters left','profilegrid-user-profiles-groups-and-communities');?>','5000')"><?php if(isset($pm_admin_note_content))echo wp_kses_post($pm_admin_note_content);?></textarea>          
                            <div class="errortext" style="display:none;"></div>
         ...
         public function pm_reset_user_password_success_popup($name,$is_emailed)
        {
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php if($is_emailed):
                        esc_html_e(sprintf("Password for user <b>%s</b> was reset and emailed successfully.",$name),"profilegrid-user-profiles-groups-and-communities");
                        else:
                            esc_html_e( sprintf("Password for user <b>%s</b> was reset successfully.",$name),'profilegrid-user-profiles-groups-and-communities');
                        endif;
                        ?>         
        ...
        <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ));?>" method="post" name="pg_change_post_status_form" id="pg_change_post_status_form">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                 ...
                 <div class="pmrow pg-info-message">        
                        ...
                        <?php esc_html_e(sprintf('You are going to change status of <b>%d</b> selected blog posts.',$count),'profilegrid-user-profiles-groups-and-communities');?>
        ...
        <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ));?>" method="post" name="pg_change_post_content_access_level" id="pg_change_post_content_access_level">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow pg-info-message">        
                        ...
                        <?php esc_html_e(sprintf('Selected <b>%d</b> post(s) will be accessible to:',$count),'profilegrid-user-profiles-groups-and-communities');?>
                ...
                <div class="pmrow ">        
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-input pm-difl">
                            <textarea name="pm_admin_note_content" id="pm_admin_note_content" maxlength="5000" size="5000" onkeyup="pg_count_left_charactors('pm_admin_note_content','pg_text_counter','{CHAR} <?php esc_html_e('characters left','profilegrid-user-profiles-groups-and-communities');?>','5000')"><?php if(isset($pm_admin_note_content))echo wp_kses_post($pm_admin_note_content);?></textarea>          
                            <div class="errortext" style="display:none;"></div>
                            <div id="pg_text_counter"><?php esc_html_e(sprintf('<b>%d</b> characters left',$char_limit),'profilegrid-user-profiles-groups-and-communities');?></div>
                        </div>
                    </div>
                </div>
                <div class="pmrow">        
        ...
        public function remove_bulk_user_in_group_popup($id,$gid)
        {
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php 
                            esc_html_e(sprintf('You are going to remove <b>%d</b> user(s). Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
         ...
         <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ));?>" method="post" name="pg_deactivate_user_in_group" id="pg_deactivate_user_in_group">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                         <?php 
                            esc_html_e(sprintf('You are going to suspend <b>%d</b> user(s). Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
        ...
        public function pg_join_paid_group_html($gid,$uid)
        {
            ...
            <form method="post" class="pmagic-form pm-dbfl">
                ...
                <input type="hidden" name="invoice" value="<?php echo esc_attr(date("His").rand(1234, 9632)); ?>" />
                 </fieldset>
         ...
         <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ));?>" method="post" name="pg_decline_bulk_join_group_requests" id="pg_decline_bulk_join_group_requests">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                         <?php 
                            esc_html_e(sprintf('You are going to decline <b>%d</b> group membership user requests. Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
         ...
         <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ));?>" method="post" name="pg_decline_bulk_join_group_requests" id="pg_decline_bulk_join_group_requests">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                         <?php 
                            esc_html_e(sprintf('You are going to approve <b>%d</b> group membership user requests. Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
        ...
        public function pg_get_profile_sections_tab_header($uid)
        {
            ...
            if(!empty($user_groups))
            {
                foreach($user_groups as $group)
                {
                    ...
                    if(!empty($sections)):
                    foreach($sections as $section):
			echo '<li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#'.sanitize_key($section->section_name).$section->id.'">'.esc_html($section->section_name).'</a></li>';
                    endforeach;
                    endif;
                }
            }
                ...
                $comments_count = wp_count_comments();
                    ...
                    <div class="pm-blog-post-wrap pm-dbfl">
                        <div class="pm-blog-img-wrap pm-difl">
                            ...
                            <div class="pm-blog-status pm-difl">
                                <span class="pm-blog-time "><?php printf(esc_html_x( '%s ago', '%s = human-readable time difference','profilegrid-user-profiles-groups-and-communities' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span>
            ...
            else
            {
                if(!empty($author))
                {
                    ...
                    else
                    {
                        ...
                        echo "<div class='pg-alert-warning pg-alert-info'> ";
                         echo sprintf(__("There are no user blog posts from %s yet.",'profilegrid-user-profiles-groups-and-communities'),$displayname);
                        echo "</div>";
                    }
                }
                else
    ...
    <path d="M0-.5h24v24H0z" fill="none"/>
            ...
            <div class="pm-section-left-panel pm-section-nav-vertical pm-difl " id="thread_pane">
                ...
                <div class="dbfl pm-new-message-area">
                    ...
                    <div class="pm-user-send-to pm-difl">To</div>
                    <div class="pm-user-send-box pm-difl">   
                        <input type="text" id="receipent_field" autocomplete="off" value="<?php if(isset($receiver_user)) echo esc_attr($receiver_user['name']); ?>" placeholder="Username" style="min-width: 100%;" onblur="pm_get_rid_by_uname(this.value)"/>
                    <input type="hidden" id="receipent_field_rid" name="rid" value="<?php if(isset($receiver_user)) echo esc_attr($receiver_user['uid']); ?>"  />   
                    </div>
