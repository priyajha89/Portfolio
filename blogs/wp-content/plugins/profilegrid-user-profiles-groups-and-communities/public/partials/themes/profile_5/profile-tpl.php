...
<div class="pmagic"> 
  ...
  <div class="pm-group-view pg-theme-five pm-dbfl">
    ...
    <div class="pm-header-section pm-dbfl pm-border pm-radius5"> 
      ...
      <div class="pm-cover-image pm-dbfl" <?php if($uid != $current_user->ID) echo 'id="pm-show-cover-image"';?> > 
        ...
        <?php if($uid == $current_user->ID && $dbhandler->get_global_option_value('pm_show_change_profile_cover_image_option','1')=='1'):?>
          <div class="pg-cover-image-mask"></div>
      ...
      <?php else:?>
      <div class="pm-cover-image pm-no-cover-image pm-dbfl" <?php if($uid != $current_user->ID) echo 'id="pm-show-cover-image"';?> ></div>   
      <?php endif; ?>
      <!-- header section -->
      <div class="pm-profile-title-header pm-dbfl">
          
          <div class="pg-profile-area-wrap pm-difl">
       <?php echo wp_kses_post($pmrequests->pm_show_profile_image_profile_page($uid, $current_user->ID, $user_info));?>
        <div class="pm-profile-title pm-difl pm-pad10">
          ...
          <div class="pg-additional-header pm-difr">
              <div class="pg-additional-info"> 
                  <div class="pg-additional-col"><?php do_action('profile_magic_show_additional_header_info',$uid);?></div> 
                  <div class="pg-additional-col pg-group-col">  
              ...
              <a href='<?php echo esc_url($group_page_link ); ?>'>
                  ...
                  <span><?php echo wp_kses_post($groupinfo->group_name);?></span>
          ...
          <?php endif;?>
                  ...
                  <div class="pg-additional-col"><?php do_action('profile_magic_show_additional_header_info2',$uid);?></div>
              </div>
