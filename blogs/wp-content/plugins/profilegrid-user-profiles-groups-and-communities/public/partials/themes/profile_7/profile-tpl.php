...
<div class="pmagic"> 
  ...
  <div class="pm-group-view pg-theme-seven pm-dbfl">
        ...
        <div class="pm-profile-title pm-difl pm-pad10">
          ...
          <div class="pm-user-group-name pm-dbfl pm-clip">
              <a href='<?php echo esc_url($group_page_link ); ?>'>
                  ...
                  <span class="pm-user-group-info"><?php echo wp_kses_post($groupinfo->group_name);?></span>
              </a>
          ...
          <?php endif;?>
             ...
             <div class="pg-additional-info pm-dbfl">
                 <div class="pg-additional-info-wrap">
                  <div class="pm-difl pg-additional-col"><?php do_action('profile_magic_show_additional_header_info',$uid);?></div> 
                  <div class="pm-difl pg-additional-col"><?php do_action('profile_magic_show_additional_header_info2',$uid);?></div>
                 </div>
              </div>
